...
<head>
  <meta charset="UTF-8">
  <title>Resolved Grievances - Digital Grievance Platform</title>
  ...
  <div class="container-fluid" style="padding-top:80px;">
    <div class="row">
      ...
      <div class="col-md-9 col-lg-10 p-4">
        <h2 class="mb-4"><i class="fas fa-check-circle me-2"></i>Resolved Grievances</h2>
              ...
              <table class="table table-hover mb-0">
                ...
                <tbody>
                  <% if (grievances.isEmpty()) { %>
                    <tr><td colspan="9" class="text-center">No resolved grievances found.</td></tr>
                  <% } else {
                    ...
                    <tr>
                      ...
                      <td><%= g.priority %></td>
                      <td><%= g.department %></td>
                      <td><span class="badge status-resolved"><%= g.status %></span></td>
                      <td><%= g.createdAt %></td>
                      <td>
